...
if (isset($_POST["submit"])) {
    ...
    $query = "DELETE FROM admin_panel WHERE id='$deleteurl'";
    $execute = mysqli_query($connection, $query);
    move_uploaded_file($_FILES["image"]["tmp_name"],$target);
    if ($execute) {
        echo $_SESSION["SuccessMessage"] = "Post Deleted successfully";
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <div>
                    <?php
                        $searchqueeryparamter = $_GET['delete'];
                        $connection;
                    ...
                    ?>
                    <form action="deletePost.php?delete=<?php echo $searchqueeryparamter ?>" method="post" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <select disabled name="category" class="form-control" id="categorySelect">
                                    <?php
                                        global $connection;
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea disabled class="form-control" type="file" name="post" id="post"><?php echo $post ?></textarea>
                                </div>
                            </div>
